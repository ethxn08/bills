...
const translations = {
  es: {
    ...
    expensesPage: {
      quickExpensesTitle: "Gastos rapidos",
      quickExpensesSubtitle: "Anade en un toque los gastos que haces a menudo.",
      quickExpenseCoffee: "Cafe",
      quickExpenseGas: "Gasolina",
      quickExpenseGroceries: "Supermercado",
      quickExpenseLunch: "Comida fuera",
    ...
    expenseList: {
      ...
      recurringDaily: "Cada dia",
      recurringWeekly: "Cada semana",
      recurringMonthly: "Cada mes",
      edit: "Editar",
      delete: "Eliminar",
    },
    budgetAlerts: {
    ...
    insights: {
      ...
      previousMonthTotal: "Mes anterior: {{amount}}",
      projectedClose: "Cierre estimado",
      projectedDelta: "Proyeccion: {{amount}} vs. ahora",
      closedMonth: "Mes cerrado, sin proyeccion adicional",
      budgetPressure: "Presion presupuestaria",
      budgetPressureValue: "{{over}} superadas · {{near}} al limite",
      peakMonth: "Mes mas intenso",
      peakMonthAmount: "Pico de gasto: {{amount}}",
      movementDensity: "Ritmo diario",
      movementsPerDay: "{{value}} gastos al dia",
  ...
  en: {
    ...
    expensesPage: {
      quickExpensesTitle: "Quick expenses",
      quickExpensesSubtitle: "Add the expenses you make often in one tap.",
      quickExpenseCoffee: "Coffee",
      quickExpenseGas: "Gas",
      quickExpenseGroceries: "Groceries",
      quickExpenseLunch: "Eating out",
    ...
    insights: {
      ...
      previousMonthTotal: "Previous month: {{amount}}",
      projectedClose: "Projected close",
      projectedDelta: "Projection: {{amount}} vs. current",
      closedMonth: "Closed month, no additional projection",
      budgetPressure: "Budget pressure",
      budgetPressureValue: "{{over}} over · {{near}} near limit",
      peakMonth: "Peak month",
      peakMonthAmount: "Spending peak: {{amount}}",
      movementDensity: "Daily pace",
      movementsPerDay: "{{value}} expenses per day",
